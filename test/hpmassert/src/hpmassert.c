 ...
 * @param result
 */
static HPM_ALWAYS_INLINE void htpBenchmarkFunc(func_benchmark func, const char *HPM_RESTRICT name,
											   FunctionRaw *HPM_RESTRICT result) {
 ...
 */
#define HPM_BENCHMARK_FUNC_CALL(func, benchmark, index)                                                                \
	htpBenchmarkFunc(&func##sp_test, HPM_STR(func), &benchmark->results[index++])
