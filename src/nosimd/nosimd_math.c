...
HPM_IMP(void, hpm_vec4_minfv, const hpmvec4f *HPM_RESTRICT a, const hpmvec4f *HPM_RESTRICT b,
		hpmvec4f *HPM_RESTRICT c) {
	(*c)[0] = (*a)[0] < (*b)[0] ? (*a)[0] : (*b)[0];
	(*c)[1] = (*a)[1] < (*b)[1] ? (*a)[1] : (*b)[1];
	(*c)[2] = (*a)[2] < (*b)[2] ? (*a)[2] : (*b)[2];
...
HPM_IMP(void, hpm_vec8_minfv, const hpmvec8f *HPM_RESTRICT a, const hpmvec8f *HPM_RESTRICT b,
		hpmvec8f *HPM_RESTRICT c) {
...
HPM_IMP(void, hpm_vec4_sqrtfv, const hpmvec4f *HPM_RESTRICT a, hpmvec4f *HPM_RESTRICT out) {
	int i;
	for (i = 0; i < 4; i++)
		(*out)[i] = sqrtf((*a)[i]);
}
