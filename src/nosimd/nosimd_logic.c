...
HPM_IMP(hpmboolean, hpm_vec_eqfv, hpmvecf a, hpmvecf b) { return almostEqual(a, b); }

HPM_IMP(hpmboolean, hpm_vec_neqfv, hpmvecf a, hpmvecf b) { return HPM_CALLLOCALFUNC(hpm_vec_eqfv)(a, b) ? 0 : 1; }
...
HPM_IMP(hpmboolean, hpm_vec4_eqfv, const hpmvec4f *HPM_RESTRICT a, const hpmvec4f *HPM_RESTRICT b) {
	return (HPM_CALLLOCALFUNC(hpm_vec_eqfv)(hpm_vec4_getxf(*a), hpm_vec4_getxf(*b)) &&
			...
			HPM_CALLLOCALFUNC(hpm_vec_eqfv)(hpm_vec4_getwf(*a), hpm_vec4_getwf(*b)))
			   ? 1
			   : 0;
}
