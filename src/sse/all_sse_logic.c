...
HPM_IMP(hpmboolean, hpm_vec_eqfv, hpmvecf a, hpmvecf b) { return _mm_comieq_ss(_mm_set_ss(a), _mm_set_ss(b)); }

HPM_IMP(hpmboolean, hpm_vec_neqfv, hpmvecf a, hpmvecf b) { return _mm_comineq_ss(_mm_set_ss(a), _mm_set_ss(b)); }
